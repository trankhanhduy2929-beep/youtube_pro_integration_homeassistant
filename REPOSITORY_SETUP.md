...
1. Tạo repository mới `youtube_pro_integration_homeassistant`.
2. Giải nén gói source `youtube_pro_homeassistant_v5.3.0_source.zip` hoặc thư mục repository hiện tại.
3. Mở thư mục `youtube_pro_integration_homeassistant` vừa giải nén.
...
Để tạo Release tự động bằng giao diện GitHub, tạo tag/release `v5.3.0`. Nếu
...
git init
git add .
git commit -m "Release YouTube Pro integration 5.3.0"
git branch -M main
git remote add origin https://github.com/trankhanhduy2929-beep/youtube_pro_integration_homeassistant.git
...
```text
https://github.com/trankhanhduy2929-beep/youtube_pro_integration_homeassistant
```
