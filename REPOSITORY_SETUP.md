...
2. Giải nén gói source `youtube_pro_homeassistant_v5.2.0_source.zip` hoặc thư mục repository hiện tại.
...
Để tạo Release tự động bằng giao diện GitHub, tạo tag/release `v5.2.0`. Nếu
...
git init
git add .
git commit -m "Release YouTube Pro integration 5.2.0"
git branch -M main
