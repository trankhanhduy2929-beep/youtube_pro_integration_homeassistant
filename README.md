...
Custom integration **YouTube Pro 5.1.0** cho Home Assistant. Integration này
...
1. Khởi động add-on **YouTube Pro 5.1.0** trên cổng `2032`.
...
- Service: `youtube_pro.play`, `youtube_pro.play_playlist`,
  `youtube_pro.enqueue`, `youtube_pro.start_radio`, `youtube_pro.set_timer`.
...
Repository này có workflow kiểm tra tự động. Khi tạo tag dạng `v5.1.0`, GitHub
Actions sẽ tạo các asset:

- `youtube_pro.zip`: asset HACS.
- `youtube_pro_manual.zip`: gói cài thủ công.
- `youtube_pro_homeassistant_v5.1.0_source.zip`: source repository.
